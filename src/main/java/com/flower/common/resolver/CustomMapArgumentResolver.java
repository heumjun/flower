package com.flower.common.resolver;
...
import com.flower.common.interceptor.Interceptor;
import com.flower.common.util.MessageUtil;
import com.flower.common.util.SessionUtil;
...
public class CustomMapArgumentResolver implements HandlerMethodArgumentResolver
{
			...
			NativeWebRequest webRequest, WebDataBinderFactory binderFactory) throws Exception
	{
		...
		// 프로퍼티에서 관리자아이디를 취득하여 CommandMap에 설정한다.
		//commandMap.put(Constants.APPROVAL_ADMIN, MessageUtil.getMessage("approval.admin"));
		//commandMap.put(Constants.APPROVAL_PHONE, MessageUtil.getMessage("approval.phone"));
