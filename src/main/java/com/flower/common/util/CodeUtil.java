...
public class CodeUtil
{
	...
	private static final String		PARA_KEY			= "GE^ITMS0";
	// 각 사 또는 시스템별로 정의된 IV ( SSO와 정의된값 ) :
	private static final String		IV					= "OS$37INF";

	// SSO Cookie 복호화 변수
	private static final String		ENC_COOKIE_FORMAT	= "DES/ECB/PKCS5Padding";
	private static final String		COOKIE_KEY			= "GE";					// GE, 공통, KEY
	...
	// SSO Parameter 암호화 Method ( DES/CBC모드) - 사용안함
	...
	// SSO Cookie 복호화 Method ( DES/ECB모드)
	...
	// SSO Cookie 암호화 Method ( DES/ECB모드) - 사용안함 ( EP에서 Cookie 암호화 해서 Set 해줌.)
